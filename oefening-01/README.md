...
- [x] Maak het volgende voorbeeld na met behulp van HTML. Gebruik hiervoor de elementen uit de vorige labo's, en zoek op hoe je gebruik maakt van de elementen `video`, `audio` en `iframe`.
- [x] Gebruik voor video volgende links:
...
- [x] Gebruik voor audio volgende links:
...
- [x] Gebruik volgend iframe (anders dan op voorbeeld):
